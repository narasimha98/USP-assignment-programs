// C program to illustrate use of open() system call
...
int main()
{
  ...
  //then file open.txt is created in the directory: /home/vishal

  int fd=open("/home/vishal/open.txt",O_RDONLY|O_CREAT);
  printf("fd=%d\n",fd);
  if(fd==-1)
{ 
  // print which type of error have in the open.txt file.
